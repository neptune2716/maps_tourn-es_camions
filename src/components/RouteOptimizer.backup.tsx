...
import { Upload, MapPin, Play, AlertCircle, AlertTriangle, Settings2, Car, Truck, Clock, Fuel, Navigation, FileText, Map } from 'lucide-react';
  ...
  return (
    <div className="h-[calc(100vh-4rem)] bg-gray-50 overflow-hidden">
      <div className="h-full p-2 sm:p-4">
        {/* Main Grid Layout: 4 columns x 4 rows */}
        <div className="grid grid-cols-4 grid-rows-4 gap-2 sm:gap-4 h-full">
          {/* Emplacements - Column 1, Rows 1-3 */}
              ...
              <div className="card">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="btn-secondary flex items-center text-sm px-3 py-2 touch-manipulation"
                  >
              ...
              <div className="xl:col-span-8">
                <div className="card relative">
                  ...
                  <OpenStreetMapComponent 
                    locations={locations}
                    route={route}
                    className="h-[280px] sm:h-[380px] lg:h-[480px] rounded-lg"
                  />
                </div>
              </div>
